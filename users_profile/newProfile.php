        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 m-9">
            <div>
                <div class="flex flex-row items-center w-full lg:w-4/5 mb-7 lg:m-0 border-gray-700 border-solid border-2 rounded-lg">
                    <label for="txtNameProfile" class="p-2 bg-gray-700 text-white">Nombre:</label>
                    <input type="text" name="txtNameProfile" id="txtNameProfile" maxlength="50" class="p-1 w-full rounded-r-lg outline-none" autofocus required>
                </div>
            </div>
            <div>
                <div class="flex flex-row items-center w-full lg:w-4/5 mb-7 lg:m-0 border-gray-700 border-solid border-2 rounded-lg">
                    <label for="txtLastNameProfile" class="p-2 bg-gray-700 text-white">Apellido:</label>
                    <input type="text" name="txtLastNameProfile" id="txtLastNameProfile" maxlength="50" class="p-1 w-full rounded-r-lg outline-none" required>
                </div>
            </div>
            <div>
                <div class="flex flex-row items-center w-full lg:w-4/5 mb-7 lg:m-0 border-gray-700 border-solid border-2 rounded-lg">
                    <label for="txtUserProfile" class="p-2 bg-gray-700 text-white">Usuario:</label>
                    <input type="text" name="txtUserProfile" id="txtUserProfile" value="" class="p-1 w-full rounded-r-lg outline-none" readonly>
                </div>
            </div>
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-3 m-9">
            <div>
                <div class="flex flex-row items-center w-full lg:w-4/5 mb-7 lg:m-0 border-gray-700 border-solid border-2 rounded-lg">
                    <label for="txtEmailProfile" class="p-2 bg-gray-700 text-white">EMAIL:</label>
                    <input type="email" name="txtEmailProfile" id="txtEmailProfile" class="p-1 w-full rounded-r-lg outline-none" required>
                </div>
            </div>
            <div>
                <div class="flex flex-row items-center w-full lg:w-4/5 mb-7 lg:m-0 border-gray-700 border-solid border-2 rounded-lg">
                    <label for="txtPassProfile" class="p-2 bg-gray-700 text-white">Password:</label>
                    <input type="password" name="txtPassProfile" id="txtPassProfile" value="donboscoSV" class="p-1 w-full rounded-r-lg outline-none" title="donboscoSV" readonly>
                </div>
            </div>
            <div>
                <div class="flex flex-row items-center w-full lg:w-4/5 mb-7 lg:m-0 border-gray-700 border-solid border-2 rounded-lg">
