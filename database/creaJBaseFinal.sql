...
CREATE TABLE IF NOT EXISTS `calificador_creaj`.`Ranking` (
  ...
  PRIMARY KEY (`idRanking`, `proyecto_idproyecto`, `proyecto_grado_idgrado`, `proyecto_materia_idmateria`),
...
CREATE TABLE IF NOT EXISTS `calificador_creaj`.`parametros` (
  ...
  `paramFecha` DATE NULL ,
  `paramFechaF` DATE NULL,
