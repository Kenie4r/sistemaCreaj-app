...
-- -----------------------------------------------------
-- Table `calificador_creaj`.`roles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`roles` ;

CREATE TABLE IF NOT EXISTS `calificador_creaj`.`roles` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`usuario` ;
...
CREATE TABLE IF NOT EXISTS `calificador_creaj`.`usuario` (
  ...
  INDEX `fk_usuario_roles1_idx` (`roles_idrol` ASC) VISIBLE,
  CONSTRAINT `fk_usuario_roles1`
    FOREIGN KEY (`roles_idrol`)
    REFERENCES `calificador_creaj`.`roles` (`idrol`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`estudiante` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`nivel` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`grado` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`materia` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`proyecto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`equipo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`rubrica` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`criterios` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`asignacionJ` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`puntaje` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`puntos` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`Ranking` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calificador_creaj`.`naprobacion` ;
