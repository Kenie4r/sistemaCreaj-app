                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                  <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6">
                      ...
                      <input type="text" name="materia" id="materia" autocomplete="mat" pattern="[a-zA-Z ]{1,50}" oninvalid="setCustomValidity('Por favor solo escriba letras ')" class="mt-1  focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                    </div>
                      </div>
