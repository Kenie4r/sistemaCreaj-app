                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                  <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6">
                      ...
                      <input type="text" value="<?php echo $nombre?>" name="materia" id="materia" oninvalid="setCustomValidity('Por favor solo escriba letras ')" autocomplete="mat" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                      </div>
