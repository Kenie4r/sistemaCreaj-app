        ...
        <form action="updatePassword.php" method="POST" class="w-full bg-gray-800 p-4 rounded-lg shadow-lg" name="frmPassword" id="frmPassword">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 text-gray-300">
                <div class="flex flex-col items-center m-8 rounded-lg">
                    <label for="txtNewPassProfile">Nueva Password (Max. 20 caracteres):</label>
                    <input type="password" name="txtNewPassProfile" id="txtNewPassProfile" class="p-1 w-4/5 bg-gray-800 border-b-2 border-solid border-gray-900 focus:border-gray-600 outline-none" size="10" maxlength="20" autofocus>
                </div>
                <div class="flex flex-col items-center w-full m-8 rounded-lg">
                    <label for="txtConfirmPassProfile">Confirmar nueva password:</label>
                    <div>
                        <input type="password" name="txtConfirmPassProfile" id="txtConfirmPassProfile" class="p-1 bg-gray-800 border-b-2 border-solid border-gray-900 focus:border-red-500 outline-none" maxlength="20">
            ...
            <div class="flex items-center justify-center">
                <div class="flex flex-col items-center w-full m-8 text-gray-300">
                    ...
                    <div>
                        <input type="password" name="txtActualPassProfile" id="txtActualPassProfile" class="p-1 w-4/5 bg-gray-800 border-b-2 border-solid border-gray-900 focus:border-red-500 outline-none" maxlength="20">
