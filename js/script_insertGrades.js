...
function isGraded(){
    $.post("../controlador/isgraded_team.php",{
        'teamID':$('#txtuserID').val(),
        'userID':$('#txtIdTeam').val()
    }, function(result){
        var noti ="    <div id='notification' class='container  max-w-full  w-screen bg-gray-900 fixed h-screen bg-opacity-75 top-0  flex flex-col justify-center items-center'>"+
    "<div class='bg-white max-w-sm text-center opacity-100 p-2 flex flex-col items-center justify-center w-full sm:max-w-md'>"+
